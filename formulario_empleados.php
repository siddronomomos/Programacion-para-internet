...
$(document).ready(function () {
    $("#altaEmpleadoForm").submit(function (event) {
        ...
        // Validar que todos los campos obligatorios estén llenos, incluyendo la foto
        if (nombre === "" || apellidos === "" || correo === "" || password === "" || rol === "" || foto === "") {
            ...
            // Crear un objeto FormData para enviar datos del formulario, incluyendo el archivo
            ...
            $.ajax({
                ...
                contentType: false, // No configurar contenido del tipo
